...
class ReadItLaterError(Exception):
        pass


class RequestError(ReadItLaterError):
        pass


class AuthError(ReadItLaterError):
        pass


class RateLimitExceeded(ReadItLaterError):
        pass


class ServerError(ReadItLaterError):
        pass


class APIError(ReadItLaterError):
        pass
